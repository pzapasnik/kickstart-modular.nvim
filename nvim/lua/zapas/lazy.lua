...
require('lazy').setup("zapas/plugins",{
...
-- If encountering errors, see telescope-fzf-native README for installation instructions
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        extensions = {
          ['dap'] = {
            require('telescope._extensions.dap').configurations(),
            require('telescope._extensions.dap').frames(),
          },
          ['ui-select'] = {
...
vim.keymap.set('n', '<C-p>', function()
	...
	builtin.grep_string({ search = vim.fn.input("Grep > ") })
      ...
      vim.keymap.set('n', '<leader>pw', builtin.grep_string, { desc = '#telescope [S]earch current [W]ord' })
